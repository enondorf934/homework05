...
@rem ##########################################################################
@rem
@rem  hw05 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and HW05_OPTS to pass JVM options to this script.
...
@rem Execute hw05
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HW05_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.homework.Homework5.Application %CMD_LINE_ARGS%
...
:fail
rem Set variable HW05_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%HW05_EXIT_CONSOLE%" exit 1
exit /b 1
